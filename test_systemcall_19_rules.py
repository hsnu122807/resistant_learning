...
for i in range(match_count_arr.shape[0]):
    print("Match rule "+rule_arr[i]+" sample amount: "+str(match_count_arr[i]))
    analyze_result.writelines("Match rule "+rule_arr[i]+" sample amount: "+str(match_count_arr[i])+"\n")
